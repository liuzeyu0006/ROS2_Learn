...
def generate_launch_description():
    ...
    default_model_path = '/home/dameili/chapt6/chapt6_ws/src/fishbot_description/urdf/fishbot/fishbot.urdf.xacro'
...
#         output='screen'
#     )  
# 加载并激活 fishbot_diff driver_controller 控制器
    load_fishbot_diff_driver_controller = launch.actions.ExecuteProcess(
    ...
    return launch.LaunchDescription([
        ...
        launch.actions.RegisterEventHandler(
            event_handler=launch.event_handlers.OnProcessExit(
                ...
                on_exit=[load_fishbot_diff_driver_controller],
        ),
    ),    
    ])